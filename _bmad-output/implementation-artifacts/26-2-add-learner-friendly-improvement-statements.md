...
1. Given progress data is available; when the app renders progress insights; then it can show statements such as remembered words, reduced repeated errors, reading level growth, longer speaking duration, or better listening speed.
2. Every statement links to the underlying evidence category
3. The app avoids overstating improvement when data is sparse
4. Copy is understandable to Vietnamese learners.

## Tasks / Subtasks

- [ ] Define learner-friendly improvement statement templates and evidence requirements. (AC: 1-4)
- [ ] Generate statements for remembered words, reduced errors, reading level growth, speaking duration, or listening speed where data exists. (AC: 1-4)
- [ ] Add low-confidence copy that avoids overclaiming progress. (AC: 1-4)
- [ ] Test statement generation for rich, sparse, and contradictory data. (AC: 1-4)
