...
1. Given a starter pathway exists; when Home renders the plan area; then it shows current day, goal, completed days, and next milestone.
2. It does not bury the primary daily action
3. Learners can change goal or time budget from a clear settings entry point
4. The pathway view has an empty state for skipped onboarding.
