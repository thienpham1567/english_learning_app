...
1. Given the learner has at least one week of activity; when the weekly retrospective is generated; then it summarizes completed actions, strongest skill, weakest skill, repeated error pattern, review debt, and next week recommendation.
2. It can be displayed on Progress or sent as an optional notification/email in the future
3. It does not require an AI call for the deterministic baseline version
4. Tests cover summary generation with sparse and rich data.

## Tasks / Subtasks

- [ ] Create deterministic weekly retrospective generation from existing activity, skill, error, and review data. (AC: 1-4)
- [ ] Summarize completed actions, strongest/weakest skill, repeated error pattern, review debt, and next-week recommendation. (AC: 1-4)
- [ ] Render or expose the retrospective without requiring an AI call. (AC: 1-4)
- [ ] Test sparse week and rich week summaries. (AC: 1-4)
