...
1. Given Home and Progress include streak, XP, badges, and leaderboard; when outcome insights are available; then the UI gives priority to today's action, skill progress, and review needs before secondary gamification widgets.
2. Existing gamification widgets remain accessible
3. New empty states explain how to generate useful progress data
4. Mobile layout keeps the primary action visible without excessive scrolling.

## Tasks / Subtasks

- [ ] Audit Home and Progress layout priority against the new outcome insights. (AC: 1-4)
- [ ] Reorder or rebalance widgets so primary action, skill progress, and review needs appear before secondary gamification. (AC: 1-4)
- [ ] Keep XP, streaks, badges, and leaderboard accessible. (AC: 1-4)
- [ ] Test mobile layout for primary action visibility and useful empty states. (AC: 1-4)
