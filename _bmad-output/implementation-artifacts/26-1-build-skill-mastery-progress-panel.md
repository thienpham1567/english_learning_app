...
1. Given user skill state exists; when Progress loads; then it shows skill mastery for vocabulary, grammar, listening, reading, writing, speaking, and pronunciation.
2. Each skill includes proficiency, confidence, last practiced time, and next recommended review if available
3. The panel handles missing or low-confidence data gracefully
4. The same data can inform Home recommendation explanations.

## Tasks / Subtasks

- [ ] Query user skill state for core skills and normalize missing/low-confidence values. (AC: 1-4)
- [ ] Build Progress panel showing proficiency, confidence, last practiced, and next review timing. (AC: 1-4)
- [ ] Share or align explanation data with Home recommendation copy where practical. (AC: 1-4)
- [ ] Test full data, partial data, and no skill state cases. (AC: 1-4)
