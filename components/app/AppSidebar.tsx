...
export function AppSidebar() {
  ...
  return (
    <aside className="group/sidebar sticky top-0 flex h-screen w-[72px] flex-col gap-2 overflow-hidden border-r border-[var(--border)] bg-[var(--surface)] px-4 py-5 transition-[width] duration-300 hover:w-[264px] hover:shadow-[var(--shadow-lg)] max-[920px]:relative max-[920px]:h-auto max-[920px]:w-full max-[920px]:flex-row max-[920px]:items-center max-[920px]:gap-4 max-[920px]:border-r-0 max-[920px]:border-b max-[920px]:px-4 max-[920px]:py-3 max-[920px]:hover:w-full max-[920px]:hover:shadow-none">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="whitespace-nowrap text-[14px] opacity-0 transition duration-200 group-hover/sidebar:translate-x-0 group-hover/sidebar:opacity-100 max-[920px]:translate-x-0 max-[920px]:opacity-100 max-[920px]:text-[13px]">
                  {label}
                </span>
              </Link>
            </motion.div>
