...
export const SCENARIOS: Scenario[] = [
  {
    ...
    emoji: "✈️",
    description:
      "Học tiếng Anh qua tình huống tại sân bay: check-in, thông báo chuyến bay, và thay đổi vé.",
    level: "B1",
    estimatedMinutes: 20,
    bonusXp: 50,
    steps: [
        ...
        content: {
          ...
          words: [
            ...
            },
            {
              ...
              example: "The departure time is 3:00 PM.",
            },
            {
              word: "arrival",
              translation: "đến nơi",
              example: "The arrival terminal is on the left.",
            },
            {
              word: "customs",
            ...
            },
            {
              word: "terminal",
              translation: "nhà ga",
              example: "Your flight departs from Terminal 2.",
            },
            {
              word: "luggage",
              translation: "hành lý",
              example: "Please collect your luggage at carousel 5.",
            },
            {
              word: "check-in",
              translation: "làm thủ tục",
              example: "Online check-in opens 24 hours before departure.",
            },
            {
              word: "gate",
              translation: "cổng ra máy bay",
            ...
            {
              word: "delay",
              translation: "trễ/hoãn",
              example: "The flight has been delayed by 2 hours.",
            },
          ],
        },
      },
      {
        ...
        content: {
          type: "listening",
          dialogue:
            "Attention passengers on flight VN123 to Ho Chi Minh City. Due to weather conditions, your flight has been delayed. The new departure time is 5:30 PM from Gate 15. Please proceed to the lounge area. We apologize for the inconvenience.",
          questions: [
            {
              question: "What is the flight number?",
              options: ["VN321", "VN123", "VN132", "VN213"],
              correctIndex: 1,
            },
            {
            ...
            },
            {
              ...
              options: ["Gate 12", "Gate 13", "Gate 14", "Gate 15"],
              correctIndex: 3,
            },
          ],
        },
      },
      {
        ...
        content: {
          type: "speaking",
          situation:
            "You are at the airport check-in counter. The agent asks you standard questions.",
          prompts: [
...
Note: Passengers must be at the gate at least 20 minutes before departure.`,
          questions: [
            ...
            {
              question: "What type of seat does the passenger have?",
              options: ["Aisle", "Middle", "Window", "Business"],
              correctIndex: 2,
            },
            {
              question: "By what time must the passenger be at the gate?",
              options: ["14:00", "14:10", "14:20", "14:30"],
              correctIndex: 1,
            },
          ],
        },
      },
      {
        ...
        content: {
          type: "writing",
          prompt:
            "Write an email to the airline requesting to change your flight from April 15 to April 17 due to a family emergency. Include your booking reference (VN456) and request a window seat.",
          hints: [
          ...
          words: [
            {
              ...
              example: "Please send your resume to HR.",
            },
            {
              word: "qualifications",
              translation: "bằng cấp/trình độ",
              example: "What qualifications do you have?",
            },
            { word: "salary", translation: "lương", example: "What are your salary expectations?" },
            {
              word: "strengths",
              translation: "điểm mạnh",
              example: "Tell me about your strengths.",
            },
            {
              word: "experience",
              translation: "kinh nghiệm",
              example: "I have 3 years of experience in marketing.",
            },
            { word: "deadline", translation: "hạn chót", example: "I always meet my deadlines." },
            {
              word: "teamwork",
              translation: "làm việc nhóm",
              example: "Teamwork is essential in this role.",
            },
            {
              word: "promotion",
              translation: "thăng chức",
              example: "She received a promotion after 2 years.",
            },
            {
              word: "reference",
              translation: "người giới thiệu",
              example: "Can you provide two references?",
            },
            {
              word: "internship",
              translation: "thực tập",
              example: "I completed an internship at Google.",
            },
          ],
        },
      },
        ...
        content: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: ["The CEO", "The team leader", "The department head", "The HR manager"],
              correctIndex: 2,
            },
          ],
        },
...
Benefits: Health insurance, 15 days annual leave, flexible working hours`,
          questions: [
            {
              ...
              options: ["1+ years", "2+ years", "3+ years", "5+ years"],
              correctIndex: 1,
            },
            {
              question: "Which tool should candidates know?",
              options: ["Photoshop", "Excel", "Google Analytics", "AutoCAD"],
              correctIndex: 2,
            },
            {
      ...
      },
      {
        ...
        content: {
          type: "writing",
          prompt:
            "Write a thank-you email to the interviewer (Mr. Johnson) after your interview for the Marketing Coordinator position.",
          hints: [
          ...
          words: [
            {
              ...
              example: "Would you like an appetizer to start?",
            },
            {
              word: "main course",
            ...
            { word: "bill", translation: "hóa đơn", example: "Can I have the bill, please?" },
            {
              word: "reservation",
              translation: "đặt bàn",
              example: "I have a reservation for two at 7 PM.",
            },
      ...
      },
      {
        ...
        content: {
          ...
          questions: [
            ...
            {
              question: "What time?",
              options: ["7:00 PM", "7:15 PM", "7:30 PM", "8:00 PM"],
              correctIndex: 2,
            },
          ],
        },
...
Service charge: 10% | No outside food`,
          questions: [
            {
              question: "Which dish is gluten-free?",
              options: ["Pizza", "Pasta", "Salmon", "Caesar Salad"],
              correctIndex: 2,
            },
            {
              question: "How much is the Pasta Carbonara?",
              options: ["$16", "$18", "$20", "$22"],
              correctIndex: 1,
            },
            {
              question: "What is the service charge?",
              options: ["5%", "10%", "15%", "No charge"],
              correctIndex: 1,
            },
          ],
        },
      },
      {
        ...
        content: {
          type: "writing",
          prompt:
            "Write a short restaurant review for Bella Italia. Mention the food quality, service, and atmosphere. Give it a rating out of 5 stars.",
          hints: [
        ...
        content: {
          ...
          words: [
            ...
            },
            {
              ...
              example: "The diagnosis was a mild infection.",
            },
            {
              word: "treatment",
              translation: "điều trị",
              example: "What treatment do you recommend?",
            },
            {
              word: "insurance",
            ...
            },
            {
              ...
              example: "You can get the medicine at the pharmacy.",
            },
          ],
        },
      },
        ...
        content: {
          ...
          questions: [
            ...
            },
            {
              ...
              options: [
                "After 1 day",
                "After 3 days if no improvement",
                "After 7 days",
                "Next month",
              ],
              correctIndex: 1,
...
If severe reaction occurs, seek immediate medical attention`,
          questions: [
            {
              question: "How many capsules per day?",
              options: ["1", "2", "3", "4"],
              correctIndex: 2,
            },
            {
              question: "Who should NOT take this medicine?",
              options: ["Children", "Elderly", "People allergic to penicillin", "Pregnant women"],
              correctIndex: 2,
            },
            {
              question: "What should you avoid while taking this medicine?",
              options: ["Coffee", "Water", "Alcohol", "Milk"],
              correctIndex: 2,
            },
          ],
        },
      },
      {
        ...
        content: {
          type: "writing",
          prompt:
            "Write a message to your manager explaining that you need to take 2 days off due to illness. The doctor recommended rest.",
          hints: [
            "Keep it brief and professional",
            "Mention the doctor's advice",
            "State how many days off",
            "Offer to catch up on work",
          ],
          sampleAnswer:
