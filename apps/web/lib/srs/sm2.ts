...
/**
 * SM-2 spaced repetition algorithm — shared across flashcards and vocabulary review.
 *
 * @param prev     Current SM-2 state (or defaults for a new item).
...
/**
 * Returns the default SM-2 state for an item that has never been reviewed.
 */
