...
export function PWAInstallBanner() {
  ...
  return (
    <div
      className="fixed flex items-center gap-3 py-3 px-5 rounded-2xl"
      style={{
        bottom: 80,
        left: "50%",
    ...
    >
      ...
      <button
        onClick={install}
        className="py-2 px-4 border-none text-[13px] font-bold cursor-pointer"
        style={{
          borderRadius: 10,
      ...
      <button
        onClick={dismiss}
        aria-label="Đóng"
        className="bg-none border-none cursor-pointer p-1 text-sm leading-none"
