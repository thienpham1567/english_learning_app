    ...
    >
      ...
      <button
        ...
        style={{
          ...
          padding: "10px 20px",
          borderRadius: 10,
          border: isSaved ? "1px solid color-mix(in srgb, var(--success) 27%, transparent)" : "1px solid var(--accent)",
          background: isSaved ? "color-mix(in srgb, var(--success) 7%, transparent)" : "var(--accent-muted, rgba(99,102,241,0.08))",
