...
const BREADCRUMBS: Record<string, BreadcrumbEntry> = {
  ...
  "/grammar-lessons": { eyebrow: "Grammar", title: "Grammar Lessons", icon: <GraduationCap /> },
  "/grammar-roadmap": { eyebrow: "Grammar", title: "Grammar Roadmap", icon: <GitBranch /> },
    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <m.div
          ...
          className="w-[30px] h-[30px] rounded-lg grid text-sm text-accent shrink-0"
          style={{
        ...
        <div className="flex flex-col justify-center">
          <span
            className="text-[10px] uppercase leading-none font-bold text-text-muted"
          ...
          <h5
            ...
            style={{ margin: "2px 0 0", lineHeight: 1.2 }}
          >
            {crumb.title}
          </h5>
        </div>
