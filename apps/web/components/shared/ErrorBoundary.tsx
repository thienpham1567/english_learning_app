...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div
          className="flex flex-col items-center justify-center text-center h-[300px] py-12 px-6"
        >
          <div
            className="w-14 h-14 rounded-full grid place-items-center mb-4 bg-[var(--error-bg)]"
          >
          ...
          <p
            className="text-[13px] text-text-muted max-w-[400px] leading-relaxed mb-5">
