...
export function ConversationList({ activeId }: Props) {
  ...
  return (
    <div className="relative flex h-full w-[230px] shrink-0 flex-col overflow-hidden border-r border-slate-900 bg-slate-950 text-slate-300">
      ...
      <div className="relative z-10 px-4 pt-5 pb-3">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-display text-sm font-semibold italic text-slate-100 tracking-wide">
            Gia sư Tiếng Anh
          </span>
        </div>
        ...
        <button
          onClick={handleNew}
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-800 bg-slate-900/50 px-4 py-2.5 text-xs font-semibold text-slate-200 hover:bg-slate-850 hover:text-white transition-all duration-200 cursor-pointer shadow-sm active:scale-98"
        >
      ...
      {/* Divider */}
      <div className="mx-4 h-px bg-slate-800/85 relative z-10" />

      {/* Conversation List */}
      <div className="relative z-10 flex-1 overflow-y-auto px-2 py-3 space-y-1 scrollbar-thin scrollbar-thumb-slate-800 scrollbar-track-transparent">
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex h-6 w-6 items-center justify-center rounded-lg bg-slate-800 text-slate-400 hover:text-white hover:bg-slate-700 transition-colors cursor-pointer"
                    aria-label="Hủy xóa"
                  >
                    <X className="h-3 w-3" />
                  </button>
              ...
              >
                <Link
                  ...
                  className={`flex w-full flex-col gap-1 rounded-xl px-3 py-2.5 text-left transition-all duration-180 ${
                    isActive
                      ? "bg-slate-900 text-white border-l-2 border-accent shadow-sm"
                ...
                <button
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 flex h-6 w-6 items-center justify-center rounded-lg text-slate-500 opacity-0 group-hover:opacity-100 hover:bg-slate-800 hover:text-red-400 transition-all duration-200 cursor-pointer"
