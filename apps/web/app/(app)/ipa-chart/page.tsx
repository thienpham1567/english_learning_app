...
export default function IpaChartPage() {
  ...
  return (
    <div className="flex flex-col h-full h-[0px] flex-1 overflow-hidden relative">
      ...
      {/* Control bar */}
      <div
        className="flex items-center gap-3 flex-wrap bg-(--surface) shrink-0 z-[1]"
        style={{
          padding: "14px 20px",
      ...
      >
        {/* Navigation Tabs */}
        <div
          className="flex gap-1 bg-surface-alt rounded-(--radius-lg) border-2 border-border"
          style={{ padding: "3px" }}
        >
          {(
            [
            ...
            return (
              <m.button
                ...
                onClick={() => setTab(key)}
                whileTap={{ scale: 0.97 }}
                className="border-none cursor-pointer text-[13px] font-extrabold flex items-center gap-2"
                style={{
                  padding: "8px 18px",
              ...
              >
                <span>{label}</span>
                <span
                  className="text-[10.5px] rounded-full font-extrabold"
                  style={{
                    padding: "2px 6px",
        ...
        <div className="flex items-center gap-2.5" style={{ marginLeft: "auto" }}>
          ...
          <div
            ...
            style={{ gap: 3, padding: "3px", borderRadius: "var(--radius-md)" }}
          >
            {(
              [
                { value: "us", label: "🇺🇸 US" },
              ...
              return (
                <m.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="rounded-md border-none cursor-pointer text-xs font-extrabold"
                  style={{
                    padding: "5px 14px",
      ...
      {/* Legend guide */}
      <div
        className="flex items-center gap-4 bg-surface-alt flex-wrap shrink-0 z-[1]"
...
function LegendDot({ color, label }: { color: string; label: string }) {
  return (
    <span
      className="flex items-center gap-1.5 text-text-secondary font-bold"
      style={{ fontSize: 11.5 }}
    >
...
function SectionHeader({
  ...
  return (
    <div className="flex items-center gap-3" style={{ marginBottom: 14 }}>
      ...
      <span
        className="text-[11px] font-extrabold rounded-full"
        style={{
          padding: "2px 8px",
