...
function VoiceCard({
  ...
  return (
    <m.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onSelect}
      className="relative flex items-center gap-3 rounded-(--radius-lg) cursor-pointer text-left"
      style={{
        padding: "12px 14px",
    ...
    >
      ...
      <div className="flex-1 w-[0px]">
        <Flex align="center" gap={6}>
          ...
          <span
            className="text-[10px] rounded-lg font-bold items-center"
            style={{
              background:
        ...
        <Text
          className="text-[11px] block overflow-hidden"
          style={{
