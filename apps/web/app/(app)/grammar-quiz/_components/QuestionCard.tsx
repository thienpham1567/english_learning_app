        ...
        <div className="mt-6 flex flex-col gap-2">
          {question.options.map((option, i) => {
            ...
            return (
              ...
              >
                <span
                  className="flex w-[28px] h-[28px] shrink-0 items-center justify-center rounded-lg font-extrabold"
                  style={{
                    background:
                    ...
                    fontSize: 11.5,
                    color:
                      (isRevealed && (isCorrect || (isSelected && !isCorrect))) || isSelected
                        ? "var(--text-on-accent)"
                        : "var(--text-secondary)",
                    transition: "all 0.2s",
                  }}
          ...
          <div className="anim-fade-up mt-5">
            ...
            {showExplanation && (
              ...
              >
                ...
                <p
                  className="mt-2.5 text-text-secondary font-medium"
                  style={{ marginBottom: 0, fontSize: 13.5, lineHeight: 1.65 }}
                >
                ...
                {question.examples && question.examples.length > 0 && (
                  ...
                  >
                    ...
                    {question.examples.map((ex, idx) => (
                      <p
                        key={idx}
                        className="text-[13px] italic text-text-secondary font-medium"
...
function renderStem(stem: string) {
  ...
  return (
    <>
      {parts[0]}
      <span
        className="inline-block rounded-md font-extrabold text-accent"
        style={{ background: "var(--accent-light)", padding: "2px 10px" }}
      >
        _____
      </span>
      {parts[1]}
