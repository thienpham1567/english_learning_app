  ...
  return (
    <div className="mt-2.5">
      ...
      <button
        ...
        onClick={toggle}
        disabled={loading}
        className={`flex items-center gap-2 w-full px-3.5 py-2.5 rounded-xl border border-accent/30 text-[13px] font-bold text-accent-active transition-all duration-200 text-left ${
      ...
      {expanded && data && (
        <div className="anim-fade-up mt-2.5 flex flex-col gap-2.5">
          ...
          <div className="px-3.5 py-3 rounded-xl bg-accent/8 border border-accent/15">
          ...
          {/* Examples */}
          <div className="px-3.5 py-3 rounded-xl bg-card-bg border border-border">
          ...
          {/* Tip */}
          <div className="px-3.5 py-2.5 rounded-xl bg-[color-mix(in_srgb,var(--warning)_8%,var(--surface))] border border-[color-mix(in_srgb,var(--warning)_15%,var(--border))] flex items-start gap-2.5">
