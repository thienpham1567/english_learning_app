    ...
    return (
      <m.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
        <Card className="py-6 px-5 text-center gap-3" shadowSize="default">
          ...
          <div className="text-4xl font-bold text-ink font-display">
          ...
          <div>
            <button
              type="button"
              onClick={generateDrill}
              className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-lg border border-accent bg-accent text-text-on-accent cursor-pointer text-[13px] font-bold"
            >
    ...
    >
      <Card className="p-0 gap-0 overflow-hidden" shadowSize="default">
        ...
        <div className="flex items-center justify-between px-4 py-3 bg-accent/5 border-b-2 border-border">
          ...
          <span className="text-[10px] font-bold px-2.5 py-1 rounded-lg bg-accent-light text-accent-hover border border-accent/15">
        ...
        <div className="p-4 flex flex-col gap-4">
          ...
          {answered && exercise.tip && (
            <m.div
              ...
              className="mt-3.5 px-3.5 py-2.5 rounded-xl bg-accent/5 border border-accent/12 flex gap-2 items-start"
            >
