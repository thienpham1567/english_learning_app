          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {list.topics.length > 0 && (
              <select
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-bold border border-border cursor-pointer outline-none ${
        ...
        {list.unresolvedCount > 1 && (
          <div className="flex justify-end">
            <m.button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-success/35 bg-success-bg text-success text-xs font-bold cursor-pointer font-body"
            >
