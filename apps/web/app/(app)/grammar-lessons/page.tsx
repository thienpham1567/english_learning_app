            ...
            <div className="flex flex-col gap-5">
              ...
              >
                ...
                <div className="flex items-center gap-6 flex-wrap">
                  ...
                  {/* Stats grid */}
                  <div
                    className="flex-1 w-[200px] grid gap-3"
              ...
              {recommendedTopic && (
                ...
                >
                  ...
                  >
                    ...
                    {/* Icon */}
                    <div
                      className="w-[48px] h-[48px] grid shrink-0"
                      style={{
                        borderRadius: 14,
                    ...
                    <div className="flex-1 relative">
                      ...
                      <div
                        ...
                        style={{ fontSize: 17, color: "#fff", marginTop: 3 }}
                      >
                    ...
                    {/* Arrow */}
                    <div
                      className="w-[36px] h-[36px] grid shrink-0"
                      style={{
                        borderRadius: 10,
                        background: "rgba(255,255,255,0.15)",
                        placeItems: "center",
  ...
  return (
    ...
    >
      <div
        ...
        style={{ borderRadius: 10, background: iconBg, placeItems: "center", color: iconColor }}
      >
        {icon}
      </div>
      <div
      ...
      <div
        className="text-lg font-black text-ink font-display"
