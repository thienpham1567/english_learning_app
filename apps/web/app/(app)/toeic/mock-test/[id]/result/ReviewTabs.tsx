...
export function ReviewTabs({
	...
	const renderList = (list: ReviewQuestion[]) => {
		if (list.length === 0) {
			return <div style={{ padding: 12, color: "var(--text-muted, #94a3b8)" }}>Không có câu nào.</div>;
		}
		return (
								...
								{q.options.map((opt, i) => {
									...
									return (
										...
										>
											...
											{isCorrect && <Tag color="green" style={{ marginLeft: 8 }}>Đáp án</Tag>}
											{isPick && !isCorrect && <Tag color="red" style={{ marginLeft: 8 }}>Bạn chọn</Tag>}
										</div>
									);
								})}
							</div>
