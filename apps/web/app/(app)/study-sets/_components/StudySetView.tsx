...
export function StudySetView({ topicId, topicTitle, level, examMode, onBack, onComplete }: Props) {
  ...
  const markDone = (section: Section) => {
    ...
    if (next.size === 4 && !allDone) {
      setAllDone(true);
      api
        .post<{ xpAwarded: number }>("/study-sets/complete", {
          topicId,
          sectionsCompleted: 4,
        })
        .then((d) => {
    ...
    return (
      ...
      >
        ...
        <m.button
          ...
          whileTap={{ scale: 0.97 }}
          className="border-none font-extrabold cursor-pointer"
          style={{
            padding: "10px 24px",
            borderRadius: 10,
  ...
  if (allDone) {
    return (
      ...
      >
        ...
        {xpAwarded > 0 && (
          <div
            className="items-center gap-1.5 text-accent font-extrabold"
            style={{
              display: "inline-flex",
              padding: "6px 16px",
              borderRadius: 20,
  ...
  return (
    <div className="anim-fade-up flex flex-col" style={{ gap: 18 }}>
      ...
      <button
        onClick={onBack}
        className="items-center gap-1.5 border-none bg-transparent text-accent cursor-pointer font-extrabold"
            ...
            >
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <strong className="text-base font-black text-text-primary font-display">
                    {w.word}
                  </strong>
                ...
                <p
                  ...
                  style={{ margin: "2px 0 6px", fontSize: 13.5 }}
                >
                  {w.meaning}
                </p>
                <div
                  className="mt-2"
                  style={{ borderLeft: "2.5px solid var(--border)", paddingLeft: 12 }}
                >
      ...
      {activeSection === "grammar" && (
        <div className="flex flex-col gap-3.5">
          ...
          >
            ...
            <p
              className="text-xl text-text-primary m-0 font-mono"
              style={{ fontWeight: 950, letterSpacing: "0.02em" }}
            >
          ...
          >
            ...
            <p
              className="text-[13px] text-text-secondary italic font-medium"
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <p
              ...
              style={{ fontSize: 14.5, lineHeight: 1.8, whiteSpace: "pre-wrap" }}
            >
          ...
          {data.reading.questions.map((q, qi) => {
            ...
            return (
              ...
              >
                  ...
                  {q.options.map((o, oi) => {
                    ...
                    if (readingRevealed) {
                      if (oi === q.answer) {
                        ...
                        color = "var(--error)";
                        iconElement = (
                          <X className="text-destructive" style={{ marginLeft: "auto" }} />
                        );
                      } else {
                        bg = "var(--surface-alt)";
                    ...
                    return (
                      <m.button
                        key={oi}
                        onClick={() => {
                          if (!readingRevealed) setReadingAnswers((p) => ({ ...p, [qi]: oi }));
                        }}
                ...
                {readingRevealed && (
                  <div
                    className="mt-3 bg-surface-alt text-text-secondary font-medium"
                    style={{
                      padding: "10px 14px",
          ...
          {!readingRevealed &&
            Object.keys(readingAnswers).length === data.reading.questions.length && (
              <m.button
                  ...
                  {ex.options.map((o) => {
                    ...
                    if (exRevealed) {
                      if (isCorrect) {
                        ...
                        color = "var(--error)";
                        iconElement = (
                          <XCircle className="text-destructive" style={{ marginLeft: "auto" }} />
                        );
                      } else {
                        bg = "var(--surface-alt)";
                        color = "var(--text-muted)";
                ...
                <AnimatePresence>
                  {exRevealed && (
                    <m.div
                      ...
                      className="mt-4 py-3 px-4 bg-surface-alt text-text-secondary font-medium"
                      style={{
                        borderRadius: "var(--radius-md)",
                        border: "1.5px solid var(--border)",
                        fontSize: 12.5,
