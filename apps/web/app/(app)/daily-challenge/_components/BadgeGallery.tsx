...
export function BadgeGallery({ badges }: Props) {
  return (
    <div className="rounded-2xl border-2 border-border bg-surface p-5 shadow-(--shadow-sm) flex flex-col gap-4">
        ...
        {badges.map((b) => {
          ...
          return (
            <m.div
              ...
              className={`p-3.5 rounded-xl border-2 flex flex-col items-center justify-center text-center shadow-(--shadow-sm) relative overflow-hidden transition-all duration-100 ${
                unlocked
            ...
            >
              ...
              <div
                className={`w-11 h-11 rounded-full border-2 grid shrink-0 place-items-center shadow-(--shadow-sm) mb-2.5 ${
                  unlocked
