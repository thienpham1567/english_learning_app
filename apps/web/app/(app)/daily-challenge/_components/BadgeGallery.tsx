        ...
        {badges.map((b) => {
          ...
          return (
            <m.div
              ...
              className="flex items-center gap-2.5 rounded-(--radius-lg) relative overflow-hidden"
              style={{
                padding: "10px 12px",
            ...
            >
              ...
              <div
                className="w-[34px] h-[34px] rounded-full grid shrink-0"
                style={{
              ...
              <div className="flex-1 w-[0px]">
                <Text
                  strong
                  className="text-xs block overflow-hidden"
                  style={{
                    lineHeight: 1.2,
              ...
              {!unlocked && (
                <div
                  ...
                  style={{ right: 8, top: 8, opacity: 0.5 }}
                >
                  <Lock />
                </div>
              )}
