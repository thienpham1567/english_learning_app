    ...
    <div className="anim-fade-up mt-6">
      ...
      >
        <div className="flex items-center gap-2.5">
          <span className="text-[13px] font-bold uppercase tracking-[0.12em] text-text-secondary">
            Verb Forms
          </span>
          <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-lg bg-accent-light text-accent-active border border-accent/20">
