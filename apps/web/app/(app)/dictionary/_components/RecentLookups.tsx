    ...
    <div className="scrollbar-none flex items-center gap-2 overflow-x-auto pb-1">
      ...
      {words.map((word) => (
        <button
          ...
          className="shrink-0 rounded-full border border-border bg-surface py-1 px-3 text-xs font-bold text-text-primary cursor-pointer whitespace-nowrap transition-all duration-150 hover:border-accent hover:bg-accent-light"
        >
          {word}
        </button>
      ))}
