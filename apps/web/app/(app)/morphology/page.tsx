  ...
  return (
    <div className="h-full overflow-y-auto p-4 md:p-6">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-5">
          <h1 className="text-2xl font-bold text-text-primary font-display">Word Formation</h1>
        ...
        {!selected && (
          <div className="flex gap-1.5 bg-surface-alt rounded-2xl p-1 border border-border shadow-sm mb-6 max-w-md">
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-left min-w-0">
                    <div className={`text-sm ${active ? "font-bold" : "font-bold"}`}>
                      {tab.label}
                    </div>
